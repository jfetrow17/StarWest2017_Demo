...
public class HotelSearch_Gen {
	...
	@Test
	 ...
	 String FileA = "/StarWestFlightSearch/graphml/HotelSearch.graphml";
	 ...
	 //PathGenerator pathGenerator = new RandomPath(new TimeDuration(100, TimeUnit.MINUTES));
	  ...
	  Result result =  new TestBuilder()
		 .addModel(FileA, new HotelSearch_API().setPathGenerator(new RandomPath((StopCondition) new EdgeCoverage(100))))
